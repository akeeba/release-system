...
<section class="akeeba-panel">
    <form action="index.php" method="post" name="adminForm" id="adminForm" class="akeeba-form--horizontal">
        <div class="akeeba-container--50-50">
            <div>
                ...
                <div class="akeeba-form-group">
                    ...
                    <?php echo Select::vgroups('vgroup_id', $this->item->vgroup_id)?>
                </div>

                <div class="akeeba-form-group">
                    <label for="type"><?php echo JText::_('COM_ARS_CATEGORIES_FIELD_TYPE'); ?></label>

					<?php echo Select::categoryType('type', $this->item->type)?>
                </div>

                <div class="akeeba-form-group">
                    <label for="directory"><?php echo JText::_('COM_ARS_CATEGORIES_FIELD_DIRECTORY'); ?></label>

                    <input type="text" name="directory" id="directory" value="<?php echo $this->escape($this->item->directory); ?>" />
                </div>
                ...
                <div class="akeeba-form-group">
					...
					<?php echo Select::booleanswitch('is_supported', $this->item->is_supported)?>
                </div>
        ...
        <div>
            <?php echo Html::rules($this->item->asset_id, 'rules', 'Categories', 'com_ars', 'category')?>
        </div>
