        ...
        <div class="akeeba-container--50-50">
            <div>
                ...
                <div class="akeeba-form-group">
					<label for="title"><?php echo Text::_('COM_ARS_CATEGORIES_FIELD_TITLE'); ?></label>

                    <input type="text" name="title" id="title" value="<?php echo $this->escape($item->title); ?>" />
                </div>

                <div class="akeeba-form-group">
					<label for="alias"><?php echo Text::_('COM_ARS_CATEGORIES_FIELD_ALIAS'); ?></label>
                ...
                <div class="akeeba-form-group">
					<label for="directory"><?php echo Text::_('COM_ARS_CATEGORIES_FIELD_DIRECTORY'); ?></label>
