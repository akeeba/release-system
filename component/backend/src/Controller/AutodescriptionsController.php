...
class AutodescriptionsController extends AdminController
{
	use ControllerEvents;
	use ControllerCopyTrait;

	protected $text_prefix = 'COM_ARS_AUTODESCRIPTIONS';

	public function getModel($name = 'Autodescription', $prefix = 'Administrator', $config = ['ignore_request' => true])
	{
