...
<table class="table table-striped" id="itemsList">
	<thead>
		...
		<tr>
			...
			<td>
				<?php echo ArsHelperSelect::releases($this->getModel()->getState('release'), 'release', array('onchange'=>'this.form.submit();','class' => 'input-medium'), $this->getModel()->getState('category')) ?>
			</td>
			<td></td>
			<td></td>
			<?php if($hasAjaxOrderingSupport === false): ?>
