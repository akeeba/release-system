...
<form name="adminForm" id="adminForm" action="index.php" method="post" class="form form-horizontal">
	...
	<div class="row-fluid">
		...
		<div class="span6">
			...
			<div class="control-group" id="row-file"
				 <?php if ($this->item->type != 'file'): ?>style="display:none"<?php endif; ?>>
			...
			<div class="control-group" id="row-url"
				 <?php if ($this->item->type != 'link'): ?>style="display:none"<?php endif; ?>>
		...
		<div class="span6">
			...
			<div class="control-group">
				<label for="show_unauth_links"
					   class="control-label"><?php echo JText::_('COM_ARS_COMMON_SHOW_UNAUTH_LINKS'); ?></label>
			...
			<div class="control-group">
				<label for="redirect_unauth"
					   class="control-label"><?php echo JText::_('COM_ARS_COMMON_REDIRECT_UNAUTH'); ?></label>

				<div class="controls">
					<input type="text" name="redirect_unauth" id="redirect_unauth"
						   value="<?php echo $this->item->redirect_unauth ?>">
				</div>
			</div>
			<?php if (ArsHelperFiltering::hasAkeebaSubs()): ?>
				<div class="control-group">
					<label for="groups"
						   class="control-label"><?php echo JText::_('COM_ARS_COMMON_CATEGORIES_GROUPS_AKEEBA_LABEL'); ?></label>
			...
			<?php elseif (defined('PAYPLANS_LOADED')): ?>
				<div class="control-group">
					<label for="groups"
						   class="control-label"><?php echo JText::_('COM_ARS_COMMON_CATEGORIES_GROUPS_PAYPLANS_LABEL'); ?></label>
			...
			<div class="control-group">
				<label for="environments"
					   class="control-label"><?php echo JText::_('LBL_ITEMS_ENVIRONMENTS'); ?></label>
			...
			<div class="control-group">
				<label for="updatestream"
					   class="control-label"><?php echo JText::_('LBL_ITEMS_UPDATESTREAM'); ?></label>
