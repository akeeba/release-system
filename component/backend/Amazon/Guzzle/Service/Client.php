...
namespace Akeeba\ARS\Amazon\Guzzle\Service;

use Akeeba\ARS\Amazon\Guzzle\Common\Collection;
use Akeeba\ARS\Amazon\Guzzle\Common\Exception\InvalidArgumentException;
use Akeeba\ARS\Amazon\Guzzle\Common\Exception\BadMethodCallException;
use Akeeba\ARS\Amazon\Guzzle\Common\Version;
use Akeeba\ARS\Amazon\Guzzle\Inflection\InflectorInterface;
use Akeeba\ARS\Amazon\Guzzle\Inflection\Inflector;
use Akeeba\ARS\Amazon\Guzzle\Http\Client as HttpClient;
use Akeeba\ARS\Amazon\Guzzle\Http\Exception\MultiTransferException;
use Akeeba\ARS\Amazon\Guzzle\Service\Exception\CommandTransferException;
...
use Akeeba\ARS\Amazon\Guzzle\Service\Command\Factory\FactoryInterface as CommandFactoryInterface;
use Akeeba\ARS\Amazon\Guzzle\Service\Resource\ResourceIteratorClassFactory;
use Akeeba\ARS\Amazon\Guzzle\Service\Resource\ResourceIteratorFactoryInterface;
use Akeeba\ARS\Amazon\Guzzle\Service\Description\ServiceDescriptionInterface;
