...
namespace Akeeba\ARS\Amazon\Guzzle\Http;

use Akeeba\ARS\Amazon\Guzzle\Common\Collection;
use Akeeba\ARS\Amazon\Guzzle\Common\AbstractHasDispatcher;
use Akeeba\ARS\Amazon\Guzzle\Common\Exception\ExceptionCollection;
...
use Akeeba\ARS\Amazon\Guzzle\Parser\UriTemplate\UriTemplateInterface;
use Akeeba\ARS\Amazon\Guzzle\Http\Message\RequestInterface;
use Akeeba\ARS\Amazon\Guzzle\Http\Message\RequestFactory;
use Akeeba\ARS\Amazon\Guzzle\Http\Message\RequestFactoryInterface;
use Akeeba\ARS\Amazon\Guzzle\Http\Curl\CurlMultiInterface;
use Akeeba\ARS\Amazon\Guzzle\Http\Curl\CurlMultiProxy;
use Akeeba\ARS\Amazon\Guzzle\Http\Curl\CurlHandle;
use Akeeba\ARS\Amazon\Guzzle\Http\Curl\CurlVersion;
