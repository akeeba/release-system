...
namespace Akeeba\ARS\Amazon\Guzzle\Http\Message;
...
use Akeeba\ARS\Amazon\Guzzle\Http\Exception\RequestException;
use Akeeba\ARS\Amazon\Guzzle\Http\Exception\BadResponseException;
use Akeeba\ARS\Amazon\Guzzle\Http\ClientInterface;
use Akeeba\ARS\Amazon\Guzzle\Http\EntityBody;
use Akeeba\ARS\Amazon\Guzzle\Http\EntityBodyInterface;
use Akeeba\ARS\Amazon\Guzzle\Http\Message\Header\HeaderInterface;
use Akeeba\ARS\Amazon\Guzzle\Http\Url;
use Akeeba\ARS\Amazon\Guzzle\Parser\ParserRegistry;
...
class Request extends AbstractMessage implements RequestInterface
{
    ...
    /**
     * @deprecated use Akeeba\ARS\Amazon\Guzzle\Plugin\Cache\DefaultCanCacheStrategy
     * @codeCoverageIgnore
     */
    public function canCache()
    {
        Version::warn(__METHOD__ . ' is deprecated. use Akeeba\ARS\Amazon\Guzzle\Plugin\Cache\DefaultCanCacheStrategy.');
        if (class_exists('Akeeba\\ARS\\Amazon\\Guzzle\\Plugin\\Cache\\DefaultCanCacheStrategy')) {
            $canCache = new \Akeeba\ARS\Amazon\Guzzle\Plugin\Cache\DefaultCanCacheStrategy();
