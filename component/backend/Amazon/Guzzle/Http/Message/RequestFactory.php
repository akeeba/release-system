...
class RequestFactory implements RequestFactoryInterface
{
    ...
    protected $requestClass = 'Akeeba\\ARS\\Amazon\\Guzzle\\Http\\Message\\Request';

    /** @var string Class to instantiate for requests with a body */
    protected $entityEnclosingRequestClass = 'Akeeba\\ARS\\Amazon\\Guzzle\\Http\\Message\\EntityEnclosingRequest';
