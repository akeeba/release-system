...
namespace Akeeba\ARS\Amazon\Guzzle\Parser;
...
class ParserRegistry
{
    ...
    protected $mapping = array(
        'message'      => 'Akeeba\\ARS\\Amazon\\Guzzle\\Parser\\Message\\MessageParser',
        'cookie'       => 'Akeeba\\ARS\\Amazon\\Guzzle\\Parser\\Cookie\\CookieParser',
        'url'          => 'Akeeba\\ARS\\Amazon\\Guzzle\\Parser\\Url\\UrlParser',
        'uri_template' => 'Akeeba\\ARS\\Amazon\\Guzzle\\Parser\\UriTemplate\\UriTemplate',
    );
    ...
    public function __construct()
    {
        ...
        if (extension_loaded('uri_template')) {
            $this->mapping['uri_template'] = 'Akeeba\\ARS\\Amazon\\Guzzle\\Parser\\UriTemplate\\PeclUriTemplate';
        }
    }
