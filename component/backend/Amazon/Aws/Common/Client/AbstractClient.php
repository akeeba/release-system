...
use Akeeba\ARS\Amazon\Aws\Common\Aws;
...
use Akeeba\ARS\Amazon\Aws\Common\Exception\TransferException;
...
use Akeeba\ARS\Amazon\Aws\Common\Signature\SignatureListener;
use Akeeba\ARS\Amazon\Aws\Common\Waiter\WaiterClassFactory;
use Akeeba\ARS\Amazon\Aws\Common\Waiter\CompositeWaiterFactory;
use Akeeba\ARS\Amazon\Aws\Common\Waiter\WaiterFactoryInterface;
use Akeeba\ARS\Amazon\Aws\Common\Waiter\WaiterConfigFactory;
use Akeeba\ARS\Amazon\Guzzle\Common\Collection;
use Akeeba\ARS\Amazon\Guzzle\Http\Exception\CurlException;
use Akeeba\ARS\Amazon\Guzzle\Service\Client;
